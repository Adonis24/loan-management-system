    ...
    return (
        !handleClick ?
            <View style={{marginBottom:10}} >
                ...
                <View style={{ alignSelf: 'center', borderBottomWidth: 1, flexDirection: 'row', marginBottom: 5, width: Layout.window.width * 0.65, borderColor: Touched && Error ? '#d94498' : '#5a83c2' }}>
