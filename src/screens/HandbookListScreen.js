            ...
            <View style={{ flex: 1, paddingTop: Constants.statusBarHeight }}>
                ...
                <View style={{ position: 'absolute', top: Constants.statusBarHeight, left: 0, bottom: 0, right: 0, }}>
                    ...
                    <View style={{ flex: 7, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        {this.props.handbooksArray&&this.props.handbooksArray.length>0?<Tabs tabBarBackgroundColor={'transparent'} tabContainerStyle={{ backgroundColor: 'transparent' }} tabBarTextStyle={[styles.textDefault, { color: '#000' }]} tabBarUnderlineStyle={{ backgroundColor: 'lightgrey' }} renderTabBar={() => <ScrollableTab />}>
