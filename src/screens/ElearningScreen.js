        ...
        return (
            <View style={{ flex: 1, paddingTop: Constants.statusBarHeight }}>
                ...
                <View style={{ position: 'absolute', top: Constants.statusBarHeight, left: 0, bottom: 0, right: 0, }}>
                    ...
                    <View style={{ flex: 7 }}>
                        <Text style={[styles.caption, { textAlign: 'left', margin: 10, alignSelf: 'flex-start', fontSize: 16, fontWeight: 'bold' }]}>Featured Videos</Text>
                        <View style={{ flexDirection: 'row', alignSelf: 'stretch' }}>
                            <View style={[styles.shadow, { backgroundColor: '#fff', flex: 1, alignSelf: 'stretch', borderRadius: 20, marginLeft: 10, marginRight: 10, borderWidth: 1, borderColor: '#ddd', paddingTop: 10, marginBottom: 20, justifyContent: 'space-between' }]}>
                                ...
                                <View style={{ flex: 1, flexDirection: 'row', margin: 5 }}>
                                    <Text style={[styles.caption, { margin: 5, }]}>Shani Raja</Text>
                                </View>
                                <View style={{ flex: 1, flexDirection: 'row', margin: 5 }}>
                                    <View style={{ flexDirection: 'row', }}><Ionicons name='ios-star' color={'yellow'} size={12} /><Ionicons name='ios-star' color={'yellow'} size={12} /><Ionicons name='ios-star' color={'yellow'} size={12} />
                                        <Text style={[styles.caption, { color: 'blue', alignSelf: 'flex-start', margin: 5, textAlign: 'left' }]}>4.5</Text>
                                    </View>
                                </View>
                        ...
                        <Text style={[styles.caption, { textAlign: 'left', margin: 10, alignSelf: 'flex-start', fontSize: 16, fontWeight: 'bold' }]}>Your Faourite</Text>
                        <View style={{ flexDirection: 'row', alignSelf: 'stretch' }}>
                            <View style={[styles.shadow, { backgroundColor: '#fff', flex: 1, alignSelf: 'stretch', borderRadius: 20, marginLeft: 10, marginRight: 10, borderWidth: 1, borderColor: '#ddd', paddingTop: 10, marginBottom: 20, justifyContent: 'space-between' }]}>
                                <Image source={require('../assets/images/logo.png')} style={{ width: undefined, height: Layout.window.height / 8, }} resizeMode='contain' />
