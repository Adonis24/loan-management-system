...
class CompanyInfoSuccessScreen extends React.PureComponent {
            ...
            <View style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, }}>
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ width: Layout.window.width * 0.8, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('ContactPerson')} style={{ width: Layout.window.width * 0.4, borderWidth: 1, borderColor: '#4A90E2', borderRadius: 15, justifyContent: 'center', alignItems: 'center', margin: 10, backgroundColor: '#4A90E2' }}>
                                <LinearGradient
                                    colors={['#4c669f', '#3b5998', '#192f6a']}
                                    style={{ paddingTop: 5, paddingBottom: 5, alignItems: 'center', borderRadius: 15, width: Layout.window.width * 0.4, }}>
                                    <Text style={[styles.textDefault, { color: '#fff' }]}>Add Employee</Text>
                                </LinearGradient>
                            </TouchableOpacity>
...
export default connect(mapStateToProps, mapDispatchToProps)(CompanyInfoSuccessScreen)