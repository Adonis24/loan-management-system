...
class BizAppDetailScreen extends React.PureComponent {
    static navigationOptions = {
        header: null,
    };

    render() {
        const uri = this.props.navigation.getParam('uri', 'NA')
        return (
...
export default connect(mapStateToProps, mapDispatchToProps)(BizAppDetailScreen)